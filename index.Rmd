...
gdp_turnout_presidential_21st |>
  ...
  geom_point() +
  geom_smooth() +
  labs(title = "Presidential Turnout Based on GDP", y = "VEP Presidential Turnout") +
  scale_x_continuous(
    labels  = label_number(scale = 1e-12, 
                           prefix = "$", 
                           suffix = "t", 
